...
<p align="center">
  <strong>Tool Created by Mohammad SaiF</strong></h3>
...
```
apt update -y && apt upgrade -y && pkg install git -y && git clone https://github.com/MohdSaif2/TermuX-Custom.git && cd TermuX-Custom && chmod +x * && bash setup.sh 
```
## Copyright Notice

All content, including but not limited to code, documentation, and assets, within the TermuX Custom repository is protected under copyright law. This repository, authored by Mohammad SaiF [Hacker], is provided for educational purposes only. It does not promote or condone any unauthorized access, modification, or misuse of computer systems or networks.
